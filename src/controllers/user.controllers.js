...
const changeCurrentPassword = asyncHandler( async (req , res) => {
    ...
    const isPasswordValid = await user.isPasswordCorrect(oldPassowrd)
...
const updateUserAvatar = asyncHandler( async (req , res) => {
    ...
    return res
    .status(200)
    .json(new ApiResponse (200 , user , "Avatar updated seccessfully"))
})
...
const updateUserCoverImage = asyncHandler( async (req , res) => {
    ...
    return res
    .status(200)
    .json(new ApiResponse (200 , user , "cover image updated seccessfully"))
})
